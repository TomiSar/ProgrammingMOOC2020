...
# Tee nyt funktio kauppalistan_tuotteet(kauppalista, maara: int) joka saa parametriksi kauppalista-olion. 
# Funktio palauttaa kauppalistan ostoksista niiden tuotteiden nimet, joita on listalla vähintään parametrin maara verran.
